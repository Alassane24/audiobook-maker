...
echo  On this PC / phone:  http://100.69.165.27:8765   (via Tailscale only)
echo  (Bound to the Tailscale IP on purpose - NOT exposed to the local Wi-Fi.)
echo.
echo  (Port 8765 - leaves 8000 free for SportsSphere/Docker.)
echo  Keep this window open. Close it to stop the server.
echo.
"A:\Cowork\audiobooks\.venv\Scripts\python.exe" -m uvicorn app:app --host 100.69.165.27 --port 8765
pause
